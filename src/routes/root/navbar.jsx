          ...
          <div className='coll-item'>
            ...
            <div class="collapse" id="collapseExample">
              <div className='coll-item-inner'>
                ...
                <div class="collapse" id="collapseinner1">
                  <div className='option'>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></input>
                      <label class="form-check-label" for="flexCheckDefault">
                        <img src="https://i.ibb.co/FBTpC1T/English-Premier-League-1.png" alt="" />
                        Premier League
                      </label>
                    </div>
                  </div>
              ...
              <div className='coll-item-inner'>
                <a className='coll-heading' data-bs-toggle="collapse" href="#collapseinner2" role="button" aria-expanded="false" aria-controls="collapseinner2">
                  <div className='coll-lable'>
                    <h5>Spanien</h5>
                  </div>
                  <div className='arrow'>
                ...
                <div class="collapse" id="collapseinner2">
                  <div className='option'>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></input>
                      <label class="form-check-label" for="flexCheckDefault">
              ...
              <div className='coll-item-inner'>
                <a className='coll-heading' data-bs-toggle="collapse" href="#collapseinner3" role="button" aria-expanded="false" aria-controls="collapseinner3">
                  <div className='coll-lable'>
                    <h5>Tyskland</h5>
                  </div>
                  <div className='arrow'>
                ...
                <div class="collapse" id="collapseinner3">
                  <div className='option'>
                    <div class="form-check">
                      <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault"></input>
                      <label class="form-check-label" for="flexCheckDefault">

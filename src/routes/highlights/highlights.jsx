...
const HighlightsList = () => {
  ...
  useEffect(() => {
    const fetchHighlights = async () => {
      if (topicKey) {
        const detailOf = (topicKey === 'england-premier-league' || topicKey === 'germany-bundesliga'  || topicKey === 'italy-serie-a' || topicKey=='italy-serie-a'  || topicKey=='france-ligue-1'|| topicKey === 'spain-la-liga' || topicKey === 'germany-bundesliga') ? "competition" : "team";
